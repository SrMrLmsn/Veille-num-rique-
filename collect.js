...
const SOURCES = [
  ...
  { name: "Conseil d'Etat", url: "https://www.conseil-etat.fr/rss/actualites.xml", category: "droit", tag: "Contrats IT" },
  { name: "Conseil d'Etat jurisp.", url: "https://www.conseil-etat.fr/rss/jurisprudence.xml", category: "droit", tag: "Contrats IT" },
  { name: "Juricaf: numerique", url: "https://juricaf.org/recherche/numerique/rss", category: "droit", tag: "Donnees personnelles" },
  { name: "Juricaf: donnees", url: "https://juricaf.org/recherche/donnees+personnelles/rss", category: "droit", tag: "Donnees personnelles" },
  { name: "Juricaf: IA", url: "https://juricaf.org/recherche/intelligence+artificielle/rss", category: "droit", tag: "IA" },
  { name: "Nouvelles.droit.org", url: "https://nouvelles.droit.org/rss/ipit.xml", category: "droit", tag: "Donnees personnelles" },
  { name: "EUR-Lex: IA", url: "https://eur-lex.europa.eu/search.html?qid=rss&text=intelligence+artificielle&scope=EURLEX&type=quick&lang=fr&RSS=true", category: "droit", tag: "IA" },
  { name: "EUR-Lex: donnees", url: "https://eur-lex.europa.eu/search.html?qid=rss&text=protection+donnees&scope=EURLEX&type=quick&lang=fr&RSS=true", category: "droit", tag: "Donnees personnelles" },
  { name: "Legifrss: numerique", url: "https://legifrss.org/latest?q=numerique", category: "droit", tag: "Contrats IT" },
